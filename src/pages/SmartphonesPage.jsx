...
import { Smartphones } from '../api/product';
...
const SmartphonesPage = () => {
  ...
  const selectedProducts = Smartphones.slice(
    startIndex,
  ...
  return (
    <div className="wrapper">
      <div className="mb-5 place-items-center">
        <h1 className="text-[30px] font-bold">Smartphones</h1>
        <button
          onClick={goToCart}
        ...
        <div className="container mx-auto flex max-w-[59.375rem] flex-col justify-center">
          ...
          <div className="mt-5 flex justify-center">
            <ReactPaginate
              ...
              nextLabel={'Next'}
              breakLabel={'...'}
              pageCount={Math.ceil(Smartphones.length / productsPerPage)}
