...
import { Laptops } from '../api/product';
...
const LaptopsPage = () => {
  ...
  const selectetProduct = Laptops.slice(
    startIndex,
  ...
  return (
    <div className="wrapper">
      <div className="mb-5 place-items-center">
        <h1 className="text-[30px] font-bold">Laptops</h1>
        <button
          onClick={goToCart}
        ...
        <div className="container mx-auto flex max-w-[59.375rem] flex-col justify-center">
              ...
              <div className="border-2 p-5" key={i}>
                ...
                <Link to={`/productdetail/${item.id}`}>
                  <img
                    src={item.img}
                    alt={item.name}
                    className="h-50 mt-2 h-[160px] lg:h-[270px] lg:w-[17.5rem]"
                  />
                </Link>
          ...
          <div className="mt-5 flex justify-center">
            <ReactPaginate
              ...
              nextLabel={'Next'}
              breakLabel={'...'}
              pageCount={Math.ceil(Laptops.length / productsPerPage)}
